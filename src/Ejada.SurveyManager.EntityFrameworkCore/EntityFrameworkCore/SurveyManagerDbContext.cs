...
public class SurveyManagerDbContext :
    AbpDbContext<SurveyManagerDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public SurveyManagerDbContext(DbContextOptions<SurveyManagerDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(SurveyManagerConsts.DbTablePrefix + "YourEntities", SurveyManagerConsts.DbSchema);
