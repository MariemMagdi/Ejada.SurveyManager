...
using Ejada.SurveyManager.HealthChecks;
...
[DependsOn(
    typeof(SurveyManagerHttpApiModule),
...
public class SurveyManagerHttpApiHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("SurveyManager");
    ...
    private void ConfigureConventionalControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(SurveyManagerApplicationModule).Assembly);
        });
    }
    ...
    private static void ConfigureSwagger(ServiceConfigurationContext context, IConfiguration configuration)
    {
        context.Services.AddAbpSwaggerGenWithOidc(
            ...
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "SurveyManager API", Version = "v1" });
    ...
    {
        context.Services.AddSurveyManagerHealthChecks();
    }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "SurveyManager API");
