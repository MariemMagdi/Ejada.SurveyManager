...
public class SurveyManagerDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public SurveyManagerDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
